...
const Main = () => {
    ...
    return (
      <div id="home" className="overflow-hidden mt-[60px] sm:mt-[2px]  md:mt-[80px] xl:mt-[20px]">
        <div className='grid grid-cols-1 md:grid-cols-2 bg-[#1D1D1D] w-full min-h-[calc(100vh-80px)] md:min-h-[350px] lg:min-h-[400px] xl:min-h-screen text-white px-4 sm:px-10'>
          <div 
            ref={parallaxRef}
